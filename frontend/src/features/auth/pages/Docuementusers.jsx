...
import { 
  ...
  FaExclamationTriangle, FaBell, FaCog, FaSearch, FaStar ,FaSignOutAlt 
} from 'react-icons/fa';
...
useEffect(() => {
  ...
  const DocumentViewer = () => {
    // Ajout d'un état pour gérer les erreurs de chargement
    const [loadError, setLoadError] = useState(false);
  
    // Déterminer le bon contenu à afficher en fonction du type de fichier
    const renderFileContent = () => {
      ...
      // Gérer le cas des documents Word (qui ne peuvent pas être prévisualisés directement)
      else if (type === 'word') {
        return (
          <div className="word-preview">
            <p>La prévisualisation n'est pas disponible pour les fichiers Word.</p>
            <a 
    ...
    <div className="modern-profile-container">
       ...
       <div className="profile-sidebar">
        ...
        <nav className="profile-nav">
          <Link to="/procedures" className="nav-item">
